...
Command: npx gltfjsx@6.5.3 macbook-14-transformed.glb -T 
Files: macbook-14-transformed.glb [627.9KB] > D:\tests\3JS-Learn\Macbook\my-app\public\models\macbook-14-transformed-transformed.glb [627.59KB] (0%)
...
export function MacbookModel14Transformed(props) {
  const { color } = useMacbookStore()
  const { nodes, materials, scene } = useGLTF('/models/macbook-14-transformed-transformed.glb')
...
useGLTF.preload('/models/macbook-14-transformed-transformed.glb')

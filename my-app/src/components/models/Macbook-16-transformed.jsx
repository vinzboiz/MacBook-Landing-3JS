...
Command: npx gltfjsx@6.5.3 macbook-16-transformed.glb -T 
Files: macbook-16-transformed.glb [629.72KB] > D:\tests\3JS-Learn\Macbook\my-app\public\models\macbook-16-transformed-transformed.glb [627.9KB] (0%)
...
export function MacbookModel16Transformed(props) {
  const { color } = useMacbookStore()
  const { nodes, materials, scene } = useGLTF('/models/macbook-16-transformed-transformed.glb')
...
useGLTF.preload('/models/macbook-16-transformed-transformed.glb')
